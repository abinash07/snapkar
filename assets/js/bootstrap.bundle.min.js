...
!function(t, e) {
    ...
    class ks extends W {
        ...
        _maybeEnableSmoothScroll() {
            this._config.smoothScroll && (N.off(this._config.target, ys),
    ...
    class fo extends W {
        ...
        show() {
            N.trigger(this._element, oo).defaultPrevented || (this._clearTimeout(),
        ...
        hide() {
            this.isShown() && (N.trigger(this._element, no).defaultPrevented || (this._element.classList.add(co),
            this._queueCallback(( () => {
